    ...
    render(){
        return (
            <div>
                ...
                <p class="principal-justify">Podcast para hablar de todo, pero principalmente temas relacionados a videojuegos, cómics y animación. Conducido por SORA y LOLO.</p>
